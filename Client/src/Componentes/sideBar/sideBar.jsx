...
export const Sidebar = () => {
  ...
  return (
    <nav className={anchoReducido ? styles.sidebarReducido : styles.sidebar}>
      ...
      <div
        className={anchoReducido ? styles.contenedorReducido : styles.contenedor}
      >
        {!anchoReducido ? (
          <>
            <h5>CUENTA / USUARIO</h5>
            <NavLink className={styles.NavLink} to="/" onClick ={cambiarDireccionFlecha} >
              <HomeIcon className={styles.iconSideBar} />
              General
            </NavLink>
            <NavLink className={styles.NavLink} to="/cuentas" onClick ={cambiarDireccionFlecha}>
              <AttachMoneyIcon className={styles.iconSideBar} />
              Cuentas
            </NavLink>
            <NavLink className={styles.NavLink} to="/clientes" onClick ={cambiarDireccionFlecha}>
              <SupervisorAccountIcon className={styles.iconSideBar} />
              Clientes
            </NavLink>
            <NavLink className={styles.NavLink} to="/configuracion" onClick ={cambiarDireccionFlecha}>
      ...
      >
        {!anchoReducido ? (
          <>
            <h5>PRODUCTOS</h5>
            <NavLink className={styles.NavLink} to="/añadirProducto" onClick ={cambiarDireccionFlecha}>
              <AddCircleIcon className={styles.iconSideBar} />
              Añadir Producto
            </NavLink>
            <NavLink className={styles.NavLink} to="/misProductos" onClick ={cambiarDireccionFlecha}>
      ...
      <div
        className={ styles.contenedorUsuarios }
      >
        {!anchoReducido ? (
          <>
            <h5>USUARIOS</h5>
            <NavLink className={styles.NavLink} to="/configPerfil" onClick ={cambiarDireccionFlecha}>
              <PersonIcon className={styles.iconSideBar} />
              Configuración de Perfil
            </NavLink>
            <NavLink className={styles.NavLink} to="/admin" onClick ={cambiarDireccionFlecha}>
              <ManageAccountsIcon className={styles.iconSideBar} />
              Administrar Usuario
            </NavLink>
            <NavLink className={styles.NavLink} onClick ={cambiarDireccionFlecha}>
