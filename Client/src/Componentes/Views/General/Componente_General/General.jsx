        ...
        <div className={styles.DivComponenteGeneral}>
            ...
            <nav className={styles.ContenedorSearchBar}>
                ...
                <div className={styles.ContenedorBotones}>
                    <NavLink className={styles.Boton} to='/'>Vista General</NavLink>
                    <NavLink className={styles.Boton} to='/clientes'>Clientes</NavLink>
                    <NavLink className={styles.Boton} to='/cuenta'>Cuenta</NavLink>
                    <NavLink className={styles.Boton} to='/pagos'>Pagos</NavLink>
                </div>
            </nav>
