...
export const getVentaById = createAsyncThunk(
  "ventas/getVentaById",
  async (id) => {
...
export const putVenta = createAsyncThunk(
  "ventas/putVenta",
  async ({ id, usuario }, { dispatch }) => {
    try {
      //id y usuario deben ser pasados en forma de objeto
